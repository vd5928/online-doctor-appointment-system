...
<html>
    ...
    <body style="background-image: url(Pic12.jpeg);">
	<div class="header">
    <ul>
        <li style="float: left; border-right: none;"> <a href="Home.php" class="logo"> <img src="Pic18.PNG" width="70px" height="50px"> <strong> Care U </strong> Online Apppointment System </a> </li>
