...
<body style="background-image: url(Pic5.jpg);">
    <link rel="stylesheet" href="main.css">
        <div class="header">
            <ul>
                <li style="float: left; border-right: none;"> <a href="Home.php" class="logo"> <img src="Pic9.png" width="70px" height="60px"> <strong>Care U</strong> Online Apppointment System </a> </li>
            </ul>
        </div>
        <div class="centre">
            <h2 style="text-align:right;"> Care U</h2><br>
