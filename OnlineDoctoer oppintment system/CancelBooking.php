<html>
    ...
    <body style="background-image: url(Pic6.jpg);">
        <div class="header">
            <ul>
                <li style="float: left; border-right: none;"><a href="Login.php" class="logo"><img src="Pic9.png" width="70px" height="60px"> <strong> Care U </strong> Online Apppointment System </a></li>
